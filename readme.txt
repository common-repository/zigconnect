...
Donate link: https://www.zigpress.com/plugins/zigconnect/
Tags: post links, posts to posts, post to post, post connection, connect posts, link posts, custom post types, zigpress, zig, classicpress
...
**PLEASE NOTE: THIS IS THE LAST VERSION. WE ARE RETIRING THIS PLUGIN.**
...
Minimum versions required: WordPress 4.5, PHP 5.3 and MySQL 5.5.3. 

Compatible with ClassicPress.

For further information and support, please visit [the ZigConnect home page](http://www.zigpress.com/plugins/zigconnect/).
...
= 0.9.9 =
* Verified compatibility with WordPress 4.9.7.
= 0.9.8 =
* Verified compatibility with WordPress 4.9.6.
= 0.9.7 =
* Verified compatibility with WordPress 4.9.
= 0.9.6 =
* Verified compatibility with WordPress 4.8.x.
= 0.9.5 =
* The resurrection release. Verified compatibility with WordPress 4.7.x, set minimum PHP version to 5.3.
* Fixed undefined data bug in metabox on post edit page.
* Changed table creation to use InnDB instead of MyISAM.
* Changed table creation to use UTF8MB4 instead of UTF8 (making minimum MySQL version 5.5.3).
= 0.9 =
