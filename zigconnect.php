...
Plugin URI: https://www.zigpress.com/plugins/zigconnect/
Version: 0.10.2
Requires at least: 4.5
Tested up to: 5.3
Description: Allows you to link post types and posts to each other and attach data directly to the links. PLEASE NOTE THIS IS THE LAST VERSION. WE ARE RETIRING THIS PLUGIN.
Author: ZigPress
...
if (!class_exists('ZigConnect')) {


	final class ZigConnect {
		...
		function __construct() {
			...
			if (version_compare(phpversion(), '5.3', '<')) $this->AutoDeactivate('ZigConnect requires PHP 5.3 or newer and has now deactivated itself. Please update your server before reactivating.');
			if (version_compare($wp_version, '4.5', '<')) $this->AutoDeactivate('ZigConnect requires WordPress 4.5 or newer and has now deactivated itself. Please update your installation before reactivating.');
			if (version_compare($wpdb->db_version(), '5.5.3', '<')) $this->AutoDeactivate('ZigConnect requires MySQL 5.5.3 or newer and has now deactivated itself. Please update your server before reactivating.');
			$this->DB = &$wpdb;
		...
		public function GetAdminHelp() {
			...
			$help .= '<li>' . __('For now data fields can be free text fields or checkboxes.', 'zigconnect') . '</li>';
			$help .= '</ul>';
		...
		public function DoAdminSidebar() {
			...
			<p><?php _e('Suggested donation: &euro;20 or an amount of your choice. Thanks!', 'zigconnect')?></p>
			</td></tr>
			</table>
			<table class="widefat donate" cellspacing="0">
			<thead>
			<tr><th><?php _e('Brought to you by ZigPress', 'zigconnect')?></th></tr>
			</thead>
			<tr><td>
			<p><a href="https://www.zigpress.com/">ZigPress</a> <?php _e('is a web agency specialising in WordPress-based solutions. We have also released a number of free plugins to support the WordPress community.', 'zigconnect')?></p>
			<p><a target="_blank" href="https://www.zigpress.com/plugins/zigconnect/"> <?php _e('ZigConnect page', 'zigconnect')?></a></p>
			<p><a target="_blank" href="https://www.zigpress.com/wordpress-plugins/"><?php _e('Other ZigPress plugins', 'zigconnect')?></a></p>
			<p><a target="_blank" href="https://www.facebook.com/pages/ZigPress/171766958751"><?php _e('ZigPress on Facebook', 'zigconnect')?></a></p>
			<p><a target="_blank" href="https://twitter.com/ZigPress"><?php _e('ZigPress on Twitter', 'zigconnect')?></a></p>
			</td></tr>
			</table>
			<?php
		}
		...
		public function DoAdminPageMain() {
			...
			if ($this->Params['zigaction'] == 'edit') {
				...
				<h2>ZigConnect - <?php _e('Edit Connection', 'zigconnect')?> <a href="<?php echo $_SERVER['PHP_SELF']?>?page=zigconnect-menu" class="button"><?php _e('Back without saving', 'zigconnect')?></a></h2>
				<div class="wrap-left">
				<div class="col-pad">
				...
				?>
				<div class="wrap zigconnect-admin">
				<h2>ZigConnect <a href="<?php echo $_SERVER['PHP_SELF']?>?page=zigconnect-menu&amp;zigaction=edit&amp;chk=-1" class="button "><?php _e('Add New Connection', 'zigconnect')?></a></h2>
				<div class="wrap-left">
				<div class="col-pad">
				<?php
				$sql  = "SELECT * ";
		...
		public function DoAdminPageFields() {
			...
			if ($this->Params['zigaction'] == 'edit') {
				...
				<h2>ZigConnect - <?php _e('Edit Field', 'zigconnect')?> <a href="<?php echo $_SERVER['PHP_SELF']?>?page=zigconnect-menu-fields" class="button"><?php _e('Back without saving', 'zigconnect')?></a></h2>
				<div class="wrap-left">
				<div class="col-pad">
				...
				<div class="wrap zigconnect-admin">
				<div id="icon-zigconnect" class="icon32"><br /></div>
				<h2>ZigConnect - <?php _e('Fields', 'zigconnect')?> <a href="<?php echo $_SERVER['PHP_SELF']?>?page=zigconnect-menu-fields&amp;zigaction=edit&amp;chk=-1" class="button"><?php _e('Add New Field', 'zigconnect')?></a></h2>
				<div class="wrap-left">
				<div class="col-pad">
				<?php
				$sql = "SELECT ";
	...
	wp_die('Namespace clash! Class ZigConnect already exists.');
